...
def info_ngentod():
	...
	print(            p+""+h+"        ["+k+" Info Created and Team "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	print(            p+""+h+"        ["+k+" TERMUX INDONESIA Team 2023 "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
	...
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
	print(           p+""+h+"   ["+k+" Hubungi Saya Di "+h+"]");time.sleep(0.03)
	print(           p+""+h+"   ["+k+" Bagi Yang Mau "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	print(           p+""+m+"   • "+h+"Whatsapp "+k+": "+O+"+62 821-8392-9059");time.sleep(0.03)
	print(           p+""+m+"   • "+h+"Telepon  "+k+": "+O+"+62 821-8392-9059");time.sleep(0.03)
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
	print(          p+""+h+"   ["+k+" Follow Github Me "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"github "+k+": "+O+"https://github.com/Ramzgod");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"github "+k+": "+O+"https://github.com/BrayennnXD");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"github "+k+": "+O+"https://github.com/A-lvino");time.sleep(0.03)
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
	print(          p+""+h+"         ["+k+" Follow Facebook Me "+p+"(>•,•<) "+h+"]");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"Facebook "+k+": "+O+"XyzonXD");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"Link Fb  "+k+": "+O+"https://www.facebook.com/100077866622074");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"Facebook "+k+": "+O+"BrayennnXD");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"Link Fb  "+k+": "+O+"https://www.facebook.com/raihan.cayankkmu");time.sleep(0.03)
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
	print(         p+""+h+"          ["+k+" Please Support and Follow We!! "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	...
	print(         p+""+h+"         ["+k+" Thanks You "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
#	raw_input (" [ ENTER ]")
