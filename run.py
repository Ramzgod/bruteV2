...
def info_ngentod():
	...
	print(          p+""+m+"   • "+h+"github "+k+": "+O+"https://github.com/YumasaaTzy");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"github "+k+": "+O+"https://github.com/YakuzaaTzy");time.sleep(0.03)
	print(          p+""+m+"   • "+h+"github "+k+": "+O+"https://github.com/Sanz-Tzy");time.sleep(0.03)
	print(P+"_____________________________________________________________________________________________________");time.sleep(0.03)
