...
def passwrd():
	...
	urut = []
	print(M+' <------------------------------------------------------------------------------------->')
	cetak(panel(f' [bold white][[bold green]•[bold white]] [bold cyan]Akun [bold white][[bold green]OK[bold white]][bold cyan] Anda Tersimpan Ke File [bold red]> [bold green]{(okc)} [bold white]\n [bold white][[bold green]•[bold white]][bold cyan] Akun [bold white][[bold yellow]CP[bold white]][bold cyan] Anda Tersimpan Ke File [bold red]> [bold yellow]{(cpc)} [bold white] \n [bold white][[bold green]![bold white] [bold cyan]Mainkan Mode Pesawat Setiap [bold yellow]1000 ID [bold cyan]Selama 2 Detik !',width=90,title=f"[bold red][[bold green] Info Crack [bold red]]",style=f"bold red"))
