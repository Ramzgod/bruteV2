...
def info_ngentod():
	...
	print(P+"_________________________________________________________________________________________");time.sleep(0.03)
	...
	print(           p+""+m+"   • "+h+"Whatsapp "+k+": "+p+"+62 821-8392-9059");time.sleep(0.03)
	print(           p+""+m+"   • "+h+"Telepon  "+k+": "+p+"+62 821-8392-9059");time.sleep(0.03)
	print(P+"_________________________________________________________________________________________");time.sleep(0.03)
