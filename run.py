...
def info_ngentod():
	...
	jalan(                                     p+""+h+"       ["+m+" >>"+k+"The Javu Avokados"+m+"<< "+p+"(>•,•<) "+h+"]");time.sleep(0.03)
	...
	jalan(           p+""+h+"   ["+k+" Bagi Yang Mau "+O+"(>•,•<) "+h+"]");time.sleep(0.03)
	jalan(           p+""+m+"   • "+h+"Whatsapp "+k+": "+O+"+62 821-8392-9059");time.sleep(0.03)
	jalan(           p+""+m+"   • "+h+"Telepon  "+k+": "+O+"+62 821-8392-9059");time.sleep(0.03)
	print(P+"________________________________________________________________________________________");time.sleep(0.03)
