...
for xd in range(10000):
	...
	#----------[ USER AGENT FAKE ASEP ]----------#
def UserAgentAsepitgans_XC():
        rr = random.randint
        ...
        d = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; 100005209 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome//{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]"
        e = f"Mozilla/5.0 (Linux; Android {str(rr(1,10))}.{str(rr(1,10))}.{str(rr(1,11))}; Z851M Build/NMF26V; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        p = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; Hisense Infinity H40 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        g = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; AGM_H5 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        h = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; ALIGATOR S5540 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/409.0.0.27.106;]"
        i = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; T790Y Build/RKQ1.210107.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        j = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; Hisense Infinity H40 Rock Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        k = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; G9 PRO Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/409.0.0.27.106;]"
        l = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; HIT P8 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        m = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; XQ-CQ54 Build/64.1.A.0.882; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        n = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; Hisense Infinity H50 ZOOM Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/409.0.0.27.106;]"
        o = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; B1 Pro Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        pp = f"Mozilla/5.0 (Linux; Android {str(rr(2,10))}.{str(rr(1,10))}.0; REVVL 2 PLUS Build/OPM1.171019.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/410.0.0.26.115;]"
        r = f"Mozilla/5.0 (Linux; Android {str(rr(2,13))}; ClearPHONE 220 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,150))}.0.{str(rr(438,4389))}.{str(rr(116,1163))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/409.0.0.27.106;]"
        return random.choice([a,b,c,d,e,p,g,h,i,j,k,l,m,n,o,pp,r])
	    ugen.append(uaku2)
